...
public class MeteoService extends MeteoService_A {
	...
	public void askAltitudeAsync() throws MeteoServiceException {
		try {
			...
			throw new MeteoServiceException(
					"[MeteoService] askAltitudeAsync failure", e);
		}
	}
	...
	public void askPressionAsync() throws MeteoServiceException {
		try {
			...
			throw new MeteoServiceException(
					"[MeteoService] : askPressionAsync failure", e);
		}
	}
	...
	public void askTemperatureAsync() throws MeteoServiceException {
		try {
			...
			throw new MeteoServiceException(
					"[MeteoService] : askTemperatureAsync failure", e);
		}
	}
	...
	protected void connectHardware() throws MeteoServiceException {
		try {
			...
			throw new MeteoServiceException("[MeteoService] : connect failure",
					e);
		}
	...
	protected void disconnectHardware() throws MeteoServiceException {
		try {
			...
			throw new MeteoServiceException(
					"[MeteoService] : disconnect failure", e);
		}
