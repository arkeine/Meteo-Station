...
public class UseSimple {
	...
	public static void main() throws MeteoServiceException {
		// MeteoService_I meteoService = (new
		// MeteoServiceSimulatorFactory()).create("COM1");
//		MeteoService_I meteoService = (new MeteoServiceFactory())
//				.create("COM7");
//		use(meteoService);

		MeteoPortDetectionService_I meteoPortDetService = new MeteoPortDetectionService();
		use(meteoPortDetService);
		
	}

	private static void use(MeteoPortDetectionService_I meteoPortDetService) {
		System.out.println(meteoPortDetService.findListPortSerie());
		System.out.println(meteoPortDetService.findListPortMeteo()); //doit afficher les ports qui sont disponible
	}
